...
var meanButton = document.getElementsByClassName('mean-button')[0]
var weightedButton = document.getElementsByClassName('weighted-button')[0]
...
function calculateMean() {
    ...
    if (count > 0) {
        ...
        displayResult('Mean of grades: 0%')
    }
...
function calculateWeighted() {
    ...
    if (totalWeight > 0) {
        ...
        displayResult('Weighted grades: 0%')
    }
}
